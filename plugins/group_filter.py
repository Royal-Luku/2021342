...
async def advantage_spell_chok(msg):
    ...
    await msg.reply("<b>I Couldn't Find Anything Related To That. Check your spelling Below</b>",
                    reply_markup=InlineKeyboardMarkup(btn))
