...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [[           
            InlineKeyboardButton('Owner', url=f'https://t.me/rcbkafan')
            ],[
            InlineKeyboardButton('Channel', url=f"https://t.me/anime_bash")
            ]]
        ...
        btn = [
            [
                InlineKeyboardButton(
                    "Join Anime Bash 😎", url=invite_link.invite_link
                )
            ]
        ]
...
async def delete(bot, message):
    ...
    if reply and reply.media:
        ...
        await message.reply('Reply to file with /remove which you want to delete', quote=True)
        return
...
async def send_msg(bot, message):
    if message.reply_to_message:
        ...
        if success:
            await message.reply_text(f"<b>Message Send To {user.mention}.</b>")
        else:
            await message.reply_text("<b>An Error Occurred !</b>")
    else:
        await message.reply_text("<b>I Think Command Incomplete...</b>")
...
async def send_chatmsg(bot, message):
    if message.reply_to_message:
        ...
        try:
            ...
            await message.reply_text(f"<b>Error : <code>{e}</code></b>")
        if success:
            await message.reply_text(f"<b>Message Send To {chat.id}.</b>")
        else:
            await message.reply_text("<b>An Error Occurred</b>")
    else:
        await message.reply_text("<b>I Think Command Incomplete...</b>")
