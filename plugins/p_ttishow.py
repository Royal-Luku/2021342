...
async def save_group(bot, message):
    ...
    if temp.ME in r_j_check:
        ...
        if message.chat.id in temp.BANNED_CHATS:
            ...
            buttons = [[
                InlineKeyboardButton('Dev', url=f'https://t.me/Rcbkafan')
            ]]
        ...
        buttons = [
            [
                InlineKeyboardButton('Join Anime Bash', url=f"https://t.me/anime_bash")
            ]
            ]
        reply_markup=InlineKeyboardMarkup(buttons)
        await message.reply_text(
            text=f"<b>Official Telegram Bot Of Anime Bash!\n\nEat Five Start Do Nothing... 😎\nSearch-Click-Downlaod</i></b>",
            reply_markup=reply_markup)
    else:
